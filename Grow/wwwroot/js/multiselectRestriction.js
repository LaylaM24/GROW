let DDLforChosen = document.getElementById("selectedRestrictionOptions");
let DDLforAvail = document.getElementById("availRestrictionOptions");
...
function switchOptions(event, senderDDL, receiverDDL) {
    ...
    let selectedRestrictionOptions = document.querySelectorAll(`#${senderID} option:checked`);
    event.preventDefault();

    if (selectedRestrictionOptions.length === 0) {
        alert("Nothing to move.");
    }
    else {
        selectedRestrictionOptions.forEach(function (o, idx) {
