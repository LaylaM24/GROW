...
namespace Grow.Controllers
{
    public class MembersController : Controller
    {
        ...
        //            {
        //                var restrictionToAdd = new MemberRestriction { MemberID = member.ID, DietaryRestrictionsID = int.Parse(restriction) };
        //                member.MemberRestrictions.Add(restrictionToAdd);
        //            }

        //            foreach (var status in selectedOptions)
        //            {
        //                var statusToAdd = new MemberIncome { MemberID = member.ID, FinancialStatusID = int.Parse(status) };
        ...
        //    if (selectedOptions == null)
        //    {
        //        memberToUpdate.MemberStatus = new List<MemberIncome>();
        //        return;
        //    }
        ...
        //            {
        //                memberToUpdate.MemberStatus.Add(new MemberIncome { MemberID = memberToUpdate.ID, FinancialStatusID = option.ID });
        //            }
        //        }
        //        else
        //        {
        //            if (memberOptionsHS.Contains(option.ID))
        //            {
        //                MemberIncome statusToRemove = memberToUpdate.MemberStatus.SingleOrDefault(m => m.FinancialStatusID == option.ID);
        ...
        //            if (!memberOptionsHS.Contains(option.ID))
        //            {
        //                memberToUpdate.MemberRestrictions.Add(new MemberRestriction { MemberID = memberToUpdate.ID, DietaryRestrictionsID = option.ID });
        //            }
        //        }
        //        else
        //        {
        //            if (memberOptionsHS.Contains(option.ID))
        //            {
        //                MemberRestriction restrictionToRemove = memberToUpdate.MemberRestrictions.SingleOrDefault(mr => mr.DietaryRestrictionsID == option.ID);
